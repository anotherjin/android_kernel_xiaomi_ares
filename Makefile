...
HOSTCC       = gcc
HOSTCXX      = g++
HOSTCFLAGS   := -Wno-everything -Wno-error=deprecated-declarations -Wno-deprecated-declarations -O2 \
...
GCC_PLUGINS_CFLAGS :=
CLANG_FLAGS := -Wno-everything -Wno-error=deprecated-declarations -Wno-deprecated-declarations
